...
`)),e.length===0?this.value="":e.includes(this.value)||(this.value=e[0]),this.emitOptionsChange([...e]),this.emitValueChange(this.value),this.exitEditMode()}onCancelClick(){this.exitEditMode()}render(){this.ensureOptions(),this.ensureSelectedValue(),this.labelElement.textContent=this.label,this.populateSelectOptions(),this.value?this.selectElement.value=this.value:this.placeholder&&(this.selectElement.value=""),this.selectElement.hidden=this.isEditing,this.editorElement.hidden=!this.isEditing,this.selectElement.disabled=this.items.length===0&&!this.editable}}customElements.define("gc-select",$);const q="data:application/json;base64,",K="data:application/json;base64,",_="data:application/json;base64,",G=document.createElement("template");G.innerHTML=`
  <style>
    ${p}
  </style>
...
`;class ie extends HTMLElement{static get prefix(){return"SettingsPage"}static get observedAttributes(){return["title","key"]}constructor(){super();const e=this.attachShadow({mode:"closed"});e.append(T.content.cloneNode(!0)),this.titleElement=e.getElementById("title"),this.onLanguageChange=this.onLanguageChange.bind(this),this.key=this.getAttribute("key")||this.constructor.prefix,this.languageSelectElement=e.getElementById("languageSelect"),this.appStore=null}connectedCallback(){var e;(e=this.appStore)==null||e.addEventListener("language-changed",this.onLanguageChange),this.render()}disconnectedCallback(){var e;(e=this.appStore)==null||e.removeEventListener("language-changed",this.onLanguageChange)}attributeChangedCallback(){this.key=this.getAttribute("key")||this.constructor.prefix,this.render()}setAppStore(e){var t;if(!e||typeof e.getLanguage!="function")throw new TypeError("appStore must provide getLanguage()");if((t=this.appStore)==null||t.removeEventListener("language-changed",this.onLanguageChange),this.appStore=e,this.languageSelectElement.setAppStore(e),this.isConnected){this.appStore.addEventListener("language-changed",this.onLanguageChange);const i=e.getLanguage();i&&this.onLanguageChange({detail:i})}}async onLanguageChange(e){const t=e==null?void 0:e.detail;typeof t=="string"||t==null||t.code;const i=t==null?void 0:t.catalog;i&&await this.applyLanguageChange(i)}async applyLanguageChange(e){var i;const t=((i=e==null?void 0:e[this.key])==null?void 0:i.title)||this.constructor.prefix;this.titleElement.textContent=t}render(){this.titleElement.textContent=this.getAttribute("title")||this.constructor.prefix}}customElements.define("gc-settings-page",ie);const P=document.createElement("template");P.innerHTML=`
  <style>
    ${p}
  </style>
...
`;class le extends HTMLElement{static get observedAttributes(){return["title","componentIdentifier"]}constructor(){super();const e=this.attachShadow({mode:"open"});e.append(O.content.cloneNode(!0)),this.titleElement=e.getElementById("title"),this.onLanguageChange=this.onLanguageChange.bind(this),this.componentIdentifier=this.getAttribute("componentIdentifier")||"MeasurementGraph"}connectedCallback(){document.addEventListener("new-language-selected",this.onLanguageChange);let e=this.componentIdentifier;document.addEventListener(e+"-add-row",this.onAddRow.bind(this)),this.render()}attributeChangedCallback(){this.componentIdentifier=this.getAttribute("componentIdentifier")||"MeasurementGraph",this.render()}disconnectedCallback(){document.removeEventListener("new-language-selected",this.onLanguageChange);let e=this.componentIdentifier;document.removeEventListener(e+"-add-row",this.onAddRow.bind(this))}async onAddRow(e){const t=e==null?void 0:e.detail;t&&Array.isArray(t.rowData)&&this.appendRowToTable(t.rowData)}async onLanguageChange(e){const t=e==null?void 0:e.detail;typeof t=="string"||t==null||t.code;const i=t==null?void 0:t.catalog;i&&await this.applyLanguageChange(i)}async applyLanguageChange(e){var r,n;const t=((r=e==null?void 0:e[this.componentIdentifier])==null?void 0:r.title)||"Graph";this.titleElement.textContent=t;const i=this.getMeasurementTableHeader(e);i&&this.setTableHeaderWithUnits(i);const o=((n=e==null?void 0:e[this.componentIdentifier])==null?void 0:n.blankRows)||5;this.getRowCount()!=o&&this.initBlankLines(o-this.getRowCount())}initBlankLines(e){const t=this.shadowRoot.getElementById("tableHeaderRow").children.length;for(let i=0;i<e;i++)this.appendRowToTable(new Array(t).fill(""))}getMeasurementTableHeader(e){var i;const t=(i=e==null?void 0:e[this.componentIdentifier])==null?void 0:i.tableHeader;return!t||typeof t!="object"?null:Array.isArray(t)?t:Object.values(t)}addTrace(e,t){let i="debug";e==="ERR"&&(i="error"),this.emitAppLog(i,`${e}: ${t}`)}render(){this.titleElement.textContent=this.getAttribute("title")||"Graph"}setTableHeader(e){const t=this.shadowRoot.getElementById("tableHeaderRow");t.innerHTML="",e.forEach(i=>{const o=document.createElement("th");o.textContent=i,t.appendChild(o)})}setTableHeaderWithUnits(e){const t=this.shadowRoot.getElementById("tableHeaderRow");t.innerHTML="",e.forEach(i=>{const o=document.createElement("th");(i.label===void 0||i.label===null)&&(i.label="????"),i.unit!==null&&i.unit!==void 0?o.innerHTML=i.label+"<br>["+i.unit+"]":o.textContent=i.label,i.tooltip!==void 0&&i.tooltip!==null&&i.tooltip!==""&&(o.title=i.tooltip),t.appendChild(o)})}appendRowToTable(e){const t=this.shadowRoot.getElementById("tableBody"),i=document.createElement("tr");e.forEach(o=>{const r=document.createElement("td");r.textContent=o,i.appendChild(r)}),t.appendChild(i)}getRowCount(){return this.shadowRoot.getElementById("tableBody").rows.length}removeRowFromTable(e){const t=this.shadowRoot.getElementById("tableBody");e>=0&&e<t.rows.length&&t.deleteRow(e)}removeAllRowsFromTable(){const e=this.shadowRoot.getElementById("tableBody");e.innerHTML="",this.render()}parseNumber(e){const t=Number.parseFloat(e);return Number.isFinite(t)?t:null}formatMetric(e,t,i){return e==null?i:e.toFixed(t)}}customElements.define("gc-graph",le);function I(a){return structuredClone(a)}class de extends EventTarget{constructor({surveyModelUrl:e="/wc/data/SurveyModel.json",appStore:t=null,surveyRepository:i=null}={}){super(),this.surveyModelUrl=e,this.appStore=t,this.surveyRepository=i,this.surveyModel=null,this.activeJobIndex=-1}async loadSurveyModel(e=this.surveyModelUrl){var o;let t=null;try{t=await((o=this.surveyRepository)==null?void 0:o.getSurvey())}catch(r){console.warn("Unable to restore the persisted survey:",r)}let i=t==null?void 0:t.surveyModel;if(!i){const r=await fetch(e);if(!r.ok)throw new Error(`Unable to load survey model (${r.status})`);i=await r.json()}if(this.validateSurveyModel(i),this.surveyModel=i,i.jobs.length>0){const r=t==null?void 0:t.activeJobIndex,n=Number.isInteger(r)&&r>=0&&r<i.jobs.length?r:0;this.setActiveJob(n,{persist:!1})}return this.emitChange("survey-loaded"),t||this.persistSurvey(),this.getSurveyModel()}validateSurveyModel(e){if(!e||typeof e!="object"||Array.isArray(e))throw new Error("Survey model must be a JSON object");if(!Array.isArray(e.jobs))throw new Error("Survey model must contain a jobs array");e.jobs.forEach((t,i)=>{if(!t||typeof t!="object"||Array.isArray(t))throw new Error(`Job ${i} must be an object`);const o=Array.isArray(t.measurements),r=Array.isArray(t.tests)&&t.tests.every(n=>n&&typeof n=="object"&&Array.isArray(n.measurements));if(!o&&!r)throw new Error(`Job ${i} must contain measurements or tests with measurements`)})}setActiveJob(e,{persist:t=!0}={}){var o;if(this.assertSurveyLoaded(),!Number.isInteger(e)||e<0||e>=this.surveyModel.jobs.length)throw new RangeError(`Job index ${e} is out of range`);this.activeJobIndex=e;const i=this.surveyModel.jobs[e];return(o=this.appStore)==null||o.setActiveJob(e,{...i,measurements:this.getActiveMeasurements()}),this.emitChange("active-job-changed"),t&&this.persistSurvey(),this.getActiveJob()}getSurveyModel(){return this.assertSurveyLoaded(),I(this.surveyModel)}getActiveJob(){return this.assertSurveyLoaded(),this.activeJobIndex<0?null:I(this.surveyModel.jobs[this.activeJobIndex])}addMeasurement(e){if(this.assertSurveyLoaded(),!e||typeof e!="object"||Array.isArray(e))throw new TypeError("Measurement must be an object");const t=this.getActiveMeasurements();if(!t)throw new Error("Select an active job before adding a measurement");const i=I(e),o=this.getMeasurementKey(i),r=t.findIndex(n=>this.getMeasurementKey(n)===o);return r>=0?t[r]=i:t.push(i),this.emitChange("measurement-saved",{measurement:i}),this.persistSurvey(),I(i)}getActiveMeasurements(){var t,i,o,r;const e=(i=(t=this.surveyModel)==null?void 0:t.jobs)==null?void 0:i[this.activeJobIndex];return e?Array.isArray(e.measurements)?e.measurements:((r=(o=e.tests)==null?void 0:o[0])==null?void 0:r.measurements)||null:null}getMeasurementKey(e){return(e==null?void 0:e.step)??(e==null?void 0:e.nr)}exportSurveyModel(){return this.assertSurveyLoaded(),JSON.stringify(this.surveyModel,null,2)}async resetSurveyModel(){var e;try{await((e=this.surveyRepository)==null?void 0:e.clearSurvey())}catch(t){console.warn("Unable to clear the persisted survey:",t)}return this.surveyModel=null,this.activeJobIndex=-1,this.loadSurveyModel()}persistSurvey(){!this.surveyRepository||!this.surveyModel||this.surveyRepository.saveSurvey(this.surveyModel,this.activeJobIndex).catch(e=>{console.warn("Unable to persist the survey:",e)})}assertSurveyLoaded(){if(!this.surveyModel)throw new Error("Load the survey model before accessing survey data")}emitChange(e,t={}){this.dispatchEvent(new CustomEvent("survey-state-change",{detail:{type:e,activeJobIndex:this.activeJobIndex,...t}}))}}class ce extends EventTarget{constructor(){super(),this.procedure=null,this.measurements=[],this.activeJobIndex=-1,this.activeJob=null,this.language=null}setProcedure(e){if(!e||typeof e!="object"||Array.isArray(e))throw new TypeError("Procedure must be an object");this.procedure=structuredClone(e),this.dispatchEvent(new CustomEvent("procedure-changed",{detail:{procedure:this.getProcedure()}}))}getProcedure(){return this.procedure?structuredClone(this.procedure):null}setActiveJob(e,t){if(!Number.isInteger(e)||e<0)throw new RangeError("Active job index must be a non-negative integer");if(!t||typeof t!="object"||Array.isArray(t))throw new TypeError("Active job must be an object");this.activeJobIndex=e,this.activeJob=structuredClone(t),this.measurements=structuredClone(t.measurements||[]),this.dispatchEvent(new CustomEvent("active-job-changed",{detail:{index:e,job:this.getActiveJob()}})),this.dispatchEvent(new CustomEvent("measurements-replaced",{detail:{measurements:this.getMeasurements()}}))}getActiveJob(){return this.activeJob?structuredClone(this.activeJob):null}setLanguage(e,t){const i=String(e||"").trim().slice(0,2).toLowerCase();if(!i||!t||typeof t!="object"||Array.isArray(t))throw new TypeError("Language requires a code and catalog object");this.language={code:i,catalog:structuredClone(t)},this.dispatchEvent(new CustomEvent("language-changed",{detail:this.getLanguage()}))}getLanguage(){return this.language?structuredClone(this.language):null}addMeasurement(e){if(!e||typeof e!="object"||Array.isArray(e))throw new TypeError("Measurement must be an object");const t=structuredClone(e),i=this.getMeasurementKey(t),o=this.measurements.findIndex(r=>this.getMeasurementKey(r)===i);o>=0?this.measurements[o]=t:this.measurements.push(t),this.activeJob&&(this.activeJob.measurements=structuredClone(this.measurements)),this.dispatchEvent(new CustomEvent("measurement-recorded",{detail:{measurement:structuredClone(t)}}))}getMeasurements(){return structuredClone(this.measurements)}getMeasurementKey(e){return(e==null?void 0:e.step)??(e==null?void 0:e.nr)}}const he="gc-gui",pe=1,w="surveys",v="primary";class ue{async getSurvey(){const e=await this.openDatabase();return this.runRequest(e,"readonly",t=>t.get(v))}async saveSurvey(e,t){const i=await this.openDatabase(),o={id:v,surveyModel:structuredClone(e),activeJobIndex:t,savedAt:new Date().toISOString()};await this.runRequest(i,"readwrite",r=>r.put(o))}async clearSurvey(){const e=await this.openDatabase();await this.runRequest(e,"readwrite",t=>t.delete(v))}openDatabase(){return globalThis.indexedDB?new Promise((e,t)=>{const i=globalThis.indexedDB.open(he,pe);i.onupgradeneeded=()=>{i.result.objectStoreNames.contains(w)||i.result.createObjectStore(w,{keyPath:"id"})},i.onsuccess=()=>e(i.result),i.onerror=()=>t(i.error||new Error("Unable to open IndexedDB"))}):Promise.reject(new Error("IndexedDB is not available"))}runRequest(e,t,i){return new Promise((o,r)=>{const n=e.transaction(w,t),s=i(n.objectStore(w));s.onsuccess=()=>o(s.result||null),s.onerror=()=>r(s.error||new Error("IndexedDB request failed")),n.onabort=()=>r(n.error||new Error("IndexedDB transaction aborted"))})}}const u=new ce,ge=new ue,H=new de({appStore:u,surveyRepository:ge}),me=new A({transports:{usb:new N({componentIdentifier:"DataUnit",storageScope:"DataUnit"}),ble:new Z({componentIdentifier:"DataUnit",serviceUuid:"6e400001-b5a3-f393-e0a9-e50e24dcca9e"})}}),C=document.getElementById("DataUnit");C&&(C.setTransportService(me),C.setConnectionControls({usbButton:document.getElementById("usbButton"),bleButton:document.getElementById("bleButton"),batteryIcon:document.getElementById("batteryIcon")}),C.setAppStore(u));const S=document.getElementById("JobPlanner");S&&S.setAppStore(u);const L=document.getElementById("SettingsPage");L&&L.setAppStore(u);const k=document.getElementById("MeasurementTable");k&&k.setAppStore(u);const be=H.loadSurveyModel().catch(a=>{throw console.error("Failed to initialize the survey model:",a),a});u.addEventListener("measurement-recorded",async a=>{try{await be,H.addMeasurement(a.detail.measurement)}catch(e){console.error("Failed to save test measurement:",e)}});
